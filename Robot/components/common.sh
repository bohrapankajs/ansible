...
sed -i -e's/MONGO_DNSNAME/172.31.83.219/' -e 's/MONGO_ENDPOINT/172.31.83.219/' -e 's/CARTENDPOINT/172.31.91.209/' -e 's/DBHOST/172.31.83.219/' -e 's/CATALOGUE_ENDPOINT/172.31.12.211/' -e 's/REDIS_ENDPOINT/172.31.82.34/' /home/$APPUSER/$COMPONENTS/systemd.service
